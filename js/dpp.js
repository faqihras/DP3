...
function tableMaster2(modulx,kode,idData){
    ...
    if (kode == 1) {
        var url = "backend/public/lang/admin/penilaian/dpp/form";
    }else if(kode == 2){
        var url = "backend/public/lang/admin/penilaian/dpp/form";
    }else if(kode == 3){
        var url = "backend/public/lang/admin/penilaian/dpp/form";
...
function loadLaporan(){
   ...
   // var tanggal=document.getElementById('tanggal').value;                         
    ...
    $.ajax({
        type: "GET",
        url: "backend/public/api/admin/config/getapimenu",
        data:({modul:modulx,dppUnit:unit}),
        dataType:"json",
        async:false,
        success:function(data){
            // console.log(data);
...
function detail_data(kode,idData){
    ...
    // alert(idData);
    if (idData == undefined) {
        idData = document.getElementById('dppId').value;
    }
    ...
    document.getElementById('dppId').value = idData;
}
...
function setFormData(idData,apiLangForm){
    ...
    $.ajax({
        type: "GET",
        url: 'backend/public/api/admin/penilaian/dpp/'+idData,
        dataType:"json",
        success:function(data){
            var isi=data.data;
