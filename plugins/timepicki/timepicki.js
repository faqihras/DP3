	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='sebelumnya action-sebelumnya'></div>" :
				"<div class='sebelumnya action-selanjutnya'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='selanjutnya action-selanjutnya'></div>" :
				"<div class='selanjutnya action-sebelumnya'></div>";
			...
			inputs.on('keydown', function(e) {
				...
				if (e.which === 38) {
					if (settings.increase_direction === 'down') {
						direction = 'sebelumnya';
					} else {
						direction = 'selanjutnya';
					}
				// DOWN
				} else if (e.which === 40) {
					if (settings.increase_direction === 'down') {
			...
			function change_time(cur_ele, direction) {
				...
				if ((cur_ele && cur_ele.hasClass('action-selanjutnya')) || direction === 'selanjutnya') {
				...
				} else if ((cur_ele && cur_ele.hasClass('action-sebelumnya')) || direction === 'sebelumnya') {
			...
			var cur_next = ele_next.find(".action-selanjutnya");
			var cur_prev = ele_next.find(".action-sebelumnya");
