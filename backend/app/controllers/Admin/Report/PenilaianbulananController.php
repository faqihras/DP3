...
class PenilaianbulananController extends BasicController {
    /**
     * Set Model's Repository
     */
     public function __construct() {
        $param=Input::all();
        $this->model = new \Admin\Report\Bulananheader();
     }
     ...
     public function index(){
           ...
           try {
                $query = DB::table($this->model->getTable())
                        ...
                        ->orderby('trpenilaianbulananheader.stokhTglTerima','desc')
     ...
     public function beforeStore(){
        ...
        for($i=1;$i<=$rec;$i++){
            ...
            if($idbarang!=''){
                $detailbarang = new \Admin\Report\Bulanandetail();
